            ...
            <div class="form-row">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                <div class="wrap">
                  ...
                  <div
                    v-if="login"
                    class="card widget-content bg-c-login Disabled"
                    :disabled="login"
                  >
                    <div class="widget-content-wrapper text-white">
                      ...
                      <div class="widget-content-left ml-2">
                        <div class="widget-heading -2 ml-0">
                          {{ $store.getters.GET_LOGIN }}
                        </div>
                      </div>
                      <div class="widget-content-right">
                        <div class="widget-numbers mr-0">
                          <span
                            class="timeDigits"
                            style="font-family: 'digital-clock-font'"
                            >{{ login }}</span
                          >
                        </div>
                      </div>
                  ...
                  <div
                    v-else
                    class="card widget-content bg-c-login"
                    :class="[login == null ? 'cardCursorPointer' : null]"
                    @click.prevent="submitAttendanceEntry('login')"
                    type="button"
                    :disabled="login"
                  >
                    <div class="widget-content-wrapper text-white">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                <div class="wrap">
                  ...
                  <div
                    v-if="break_in"
                    class="card widget-content bg-c-yellow Disabled"
                    :disabled="break_in || !login"
                  >
                    <div class="widget-content-wrapper text-white">
                      <div class="widget-content-left">
                        <div class="widget-heading">
                      ...
                      <div class="widget-content-left ml-2">
                        <div class="widget-heading ml-0">
                          {{ $store.getters.GET_BREAKIN }}
                        </div>
                      </div>

                      <div class="widget-content-right">
                        <div class="widget-numbers -2 mr-0">
                          <span
                            class="timeDigits"
                            style="font-family: 'digital-clock-font'"
                            >{{ break_in }}</span
                  ...
                  <div
                    v-else
                    class="card widget-content bg-c-yellow"
                    :class="[
                      login && break_in == null
                        ? 'cardCursorPointer'
                        : 'Disabled',
                    ]"
                    @click.prevent="submitAttendanceEntry('breakin')"
                    type="button"
                    :disabled="break_in || !login"
                  >
                    <div class="widget-content-wrapper text-white">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                <div class="wrap">
                  ...
                  <div
                    v-if="break_out"
                    class="card widget-content bg-c-blue Disabled"
                    :disabled="break_out || !break_in"
                  >
                    <div class="widget-content-wrapper text-white">
                      <div class="widget-content-left">
                        <div class="widget-heading">
                  ...
                  <div
                    v-else
                    class="card widget-content bg-c-blue"
                    :class="[
                      break_in && break_out == null
                        ? 'cardCursorPointer'
                        : 'Disabled',
                    ]"
                    @click.prevent="submitAttendanceEntry('breakout')"
                    type="button"
                    :disabled="break_out || !break_in"
                  >
                    <div class="widget-content-wrapper text-white">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                <div class="wrap">
                  ...
                  <div
                    v-if="logout"
                    class="card widget-content bg-c-red Disabled"
                    :disabled="logout || !break_out"
                  >
                    <div class="widget-content-wrapper text-white">
                      <div class="widget-content-left">
                        <div class="widget-heading">
                  ...
                  <div
                    v-else
                    class="card widget-content bg-c-red"
                    :class="[
                      break_out && logout == null
                        ? 'cardCursorPointer'
                        : 'Disabled',
                    ]"
                    @click.prevent="submitAttendanceEntry('logout')"
                    type="button"
                    :disabled="logout || !break_out"
                  >
                    <div class="widget-content-wrapper text-white">
...
export default {
  ...
  created() {
    ...
    this.voice_config_data = localStorage.getItem("voice_config");
    // this.is_voice_on = localStorage.getItem("is_on");
    // console.log("390", this.voice_config_data);
  },
  methods: {
    // is_superuser() {
